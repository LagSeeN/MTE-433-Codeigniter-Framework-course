                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <tr>
                                        <td colspan="5">
                                            <form method="get" action="<?=base_url("Amphur_New/index")?>">
                                                <a href="<?=base_url("Amphur_New/addForm")?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?=base_url("Amphur_New/editForm/$amphur->amphur_id")?>"
                                                class="btn btn-warning">Edit</a>
                                            <a href="<?=base_url("Amphur_New/delete/$amphur->amphur_id")?>"
